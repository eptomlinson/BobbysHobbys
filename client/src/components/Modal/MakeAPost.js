        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
              ...
              >
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="Name of your hobby"
                  />
                </div>
                <div className="form-group">
                  <p>Upload Image</p>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="exampleInputEmail1"
                    aria-describedby="emailHelp"
                    placeholder="Enter the cost of your project"
                  />
                </div>
                <div className="form-group">
                ...
                <button
                  type="submit"
                  className="btn post-btn btn btn-primary btn-outline-light btn-space"
                >
                  Post
                </button>
              </form>
            ...
            <div className="modal-footer">
              <button
                type="button"
                className="close-modal btn btn-secondary btn-outline-light btn-space"
                data-dismiss="modal"
              >
                Close
              </button>
